  ...
  return (
    <section id="storage-section" className="relative min-h-screen w-full bg-gradient-to-b from-emerald-900 via-emerald-800 to-emerald-900 overflow-hidden py-8 sm:py-12 md:py-20">
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-12 items-center lg:items-start justify-between">
          
          {/* Left Side - Vending Machine */}
          <motion.div 
            className="w-full lg:w-2/3 xl:w-3/5 flex flex-col items-center justify-center"
              ...
              <div className="relative w-full aspect-[1.1] 
                ...
                >
                  ...
                  <g className="cursor-pointer">
                    <rect x="305" y="145" width="50" height="55" rx="4" fill="#2a1810" onClick={() => handleSelectItem(shelfItems[0])} />
          ...
          <motion.div 
            className="w-full lg:w-1/3 xl:w-2/5 space-y-4 md:space-y-6 mt-6 sm:mt-8 lg:mt-0 lg:pl-6 xl:pl-8"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            {protectionFeatures.map((feature, index) => (
              <motion.div
                key={index}
                className="bg-gradient-to-br from-emerald-900/50 to-emerald-800/30 rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 border border-amber-500/20 backdrop-blur-sm"
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center flex-shrink-0`}>
        ...
        {/* Modal overlays - keep all existing modal code unchanged */}
        <AnimatePresence>
